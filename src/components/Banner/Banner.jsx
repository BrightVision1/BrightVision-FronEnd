        ...
        <div className="text-container">
          ...
          <div className="hero-text">
            ...
            <p>
              A company approved by Security Industry Regulatory Agency
              <br />
              in the Government of Dubai Security Professionals Association
              (SPA)
            </p>
          </div>
        </div>
...
//   <img className="Ak-img1" src={img1} alt="image1" />
//   {/* <img className="Ak-img2" src={img2} alt="image2" /> */}
//   <img className="Ak-img3" src={img3} alt="image3" />
//   <img className="Ak-img4" src={img4} alt="image4" />
//   </div>
// )}
