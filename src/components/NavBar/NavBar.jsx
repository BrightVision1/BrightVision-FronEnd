      ...
      <div className="nav mx-auto px-4 py-2 flex justify-between items-center">
        <div className="nav-item flex items-center justify-between w-full">
          ...
          <div className=" hidden lg:flex space-x-2">
            <Link
              to="/BrightVision-FronEnd//signin"
              className="buuton-info border-gray-300 rounded-full px-3 py-2"
            >
              Sign In
            </Link>
            <Link
              to="/BrightVision-FronEnd//register"
              className="buuton-info rounded-full px-3 py-2"
            >
              Register
            </Link>
          </div>
